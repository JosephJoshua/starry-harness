...
### Prompts (for orchestrator/dual-agent mode)
- **`${CLAUDE_PLUGIN_ROOT}/prompts/shared_context.md`** — Shared project context
- **`${CLAUDE_PLUGIN_ROOT}/prompts/developer_role.md`** — Developer agent role definition
- **`${CLAUDE_PLUGIN_ROOT}/prompts/reviewer_role.md`** — Reviewer agent role definition
- **`${CLAUDE_PLUGIN_ROOT}/schemas/developer.json`** — Structured output schema for developer rounds
- **`${CLAUDE_PLUGIN_ROOT}/schemas/reviewer.json`** — Structured output schema for reviewer rounds
